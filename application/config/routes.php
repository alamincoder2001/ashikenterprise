...
$route['get_damage_record'] = 'Administrator/Order/getShippingDamage';
$route['damage_cliam'] = 'Administrator/Order/cliammDamage';
$route['pending_claim'] = 'Administrator/Order/pendingClaim';
$route['get_pending_claims'] = 'Administrator/Order/getPendingClaim';
$route['approved_claim'] = 'Administrator/Order/ApprovedClaim';
$route['delete_claim'] = 'Administrator/Order/deleteClaim';
$route['get_claim_damage'] = 'Administrator/Order/getClaimDamage';