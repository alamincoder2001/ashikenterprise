...
class Purchase extends CI_Controller
{
    ...
    public function getPurchases(){
        ...
        if(isset($data->purchaseId) && $data->purchaseId != null){
            ...
            $purchaseDetails = array_map(function($detail) {
                $detail->boxQty = floor($detail->PurchaseDetails_TotalQuantity / $detail->per_unit_convert);
                $detail->pcsQty = floor($detail->PurchaseDetails_TotalQuantity % $detail->per_unit_convert);
                return $detail;
            }, $purchaseDetails);
        }
    ...
    function addDamage()
    {
        ...
        try {
            ...
            $damageDetails = array(
                ...
                'Customer_SlNo' => $data->Customer_SlNo,
    ...
    public function getDamages(){
        ...
        $damages = $this->db->query("
            ...
            join tbl_customer c on c.Customer_SlNo = dd.Customer_SlNo
