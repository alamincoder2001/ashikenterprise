					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;">{{ sale.saleDetails[0].boxQty + ' ' + sale.saleDetails[0].converted_name }}</td>
								<td style="text-align:center;">{{ sale.saleDetails[0].pcsQty + ' ' + sale.saleDetails[0].Unit_Name }}</td>
