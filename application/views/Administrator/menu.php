...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("chalanRecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>chalanRecord">
					<i class="menu-icon fa fa-list"></i>
		...
		<?php if (array_search("damage_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>damage_record">
					<i class="menu-icon fa fa-list"></i>
		...
		<?php if (array_search("pending_claim", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>pending_claim">
					<i class="menu-icon fa fa-list"></i>
