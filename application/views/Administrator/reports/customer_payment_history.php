                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="payment in payments">
							...
							<td style="text-align:right;">{{ payment.CPayment_discount }}</td>
                    ...
                    <tfoot v-if="paymentType != ''">
                        <tr>
                            ...
                            <td style="text-align:right;">{{ payments.reduce((p, c) => { return p + parseFloat(c.CPayment_discount)}, 0).toFixed(2) }}</td>
