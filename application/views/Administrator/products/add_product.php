...
<div id="products">
		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Conv. Name:</label>
					<div class="col-md-7">
			...
			<div class="col-md-2">
				<div class="form-group clearfix">
					<div style="width: 120px;height:120px;border: 1px solid #ccc;overflow:hidden;">
	...
	new Vue({
		...
		methods:{
			...
			saveProduct() {
				...
				if(this.product.Product_SlNo == '' && this.selectedFile == null) {
					alert('Select Image');
					return;
				}
