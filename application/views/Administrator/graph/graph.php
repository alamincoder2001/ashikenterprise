    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-md-2  col-xs-6 col-md-offset-5">
            <div class="widgets" style="border-top: 5px solid #1c8dff;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Total Damage</div>
                    <div class="widget-value"><?php echo $this->session->userdata('Currency_Name');?> {{ totalDamage | decimal }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        methods: {
            getGraphData(){
                axios.get('/get_graph_data').then(res => {
                    ...
                    this.totalDamage        = res.data.total_damage;
