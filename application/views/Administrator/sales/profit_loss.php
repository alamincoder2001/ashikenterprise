				...
				<table id="table1">
					...
					<tbody v-for="data in reportData">
						...
						<tr v-for="product in data.saleDetails">
							...
							<td style="text-align:right;">{{ product.saleAmount | decimal }}</td>
						...
						<tr style="background-color: #f0f0f0;font-weight: bold;">
							...
							<td style="text-align:right;">{{ data.saleDetails.reduce((prev, cur) => { return prev + parseFloat(cur.saleAmount) }, 0) | decimal }}</td>
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						<tr>
							...
							<td style="text-align:right;">
								{{ 
									reportData.reduce((prev, cur) => { return prev + parseFloat(
										cur.saleDetails.reduce((p, c) => { return p + parseFloat(c.saleAmount) }, 0)
									)}, 0).toFixed(2)
								}}
							</td>
							<td style="text-align:right;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Special Discount (-)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.cpayment_discont | decimal }}</td>
						</tr>
