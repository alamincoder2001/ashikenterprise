					...
					<div class="row">
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label no-padding-right"> Box Qty. </label>
									<div class="col-sm-3">
										<input type="number" step="0.01" id="quantity" min="0" name="quantity" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.boxQty" v-on:input="productTotal" />
									</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:10%;color:#000;">Pur. Rate</th>
							<th style="width:10%;color:#000;">Box Qty</th>
							<th style="width:10%;color:#000;">Pcs Qty</th>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<label class="col-xs-6 control-label no-padding-right"> Cur. Due</label>
											</div>
										</td>
									</tr>
		...
		methods:{
			...
			addToCart(){
				...
				let product = {
					...
					pcsQty: this.selectedProduct.pcs,
