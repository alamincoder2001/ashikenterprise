					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td style="text-align:center;">{{ purchase.purchaseDetails[0].boxQty + ' ' + purchase.purchaseDetails[0].converted_name}}</td>
								<td style="text-align:center;">{{ purchase.purchaseDetails[0].pcsQty + ' ' + purchase.purchaseDetails[0].Unit_Name }}</td>
								<td style="text-align:center;">{{ purchase.purchaseDetails[0].PurchaseDetails_TotalQuantity + ' ' + purchase.purchaseDetails[0].Unit_Name }}</td>
							...
							<tr v-for="(product, sl) in purchase.purchaseDetails.slice(1)">
								...
								<td style="text-align:center;">{{ product.boxQty + ' ' + product.converted_name }}</td>
								<td style="text-align:center;">{{ product.pcsQty + ' ' + product.Unit_Name }}</td>
								<td style="text-align:center;">{{ product.PurchaseDetails_TotalQuantity + ' ' + product.Unit_Name }}</td>
