...
$discount = $CPROW->CPayment_discount;
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <?php if($type == 'CR') { ?>
                    <tr>
                        <td  style="font-size: 13px; font-weight: 600;">Discount Amount : </td>
                        <td  style="font-size: 13px; font-weight: 600; text-align: right; "><?php echo number_format($CPROW->CPayment_discount, 2); ?></td>
                    </tr>
                    <?php } ?>
                    <tr>
