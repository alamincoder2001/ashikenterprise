        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="orderRecord" v-model="access"> Pending Order</li>
                    ...
                    <li><input type="checkbox" class="access" value="chalanRecord" v-model="access"> Chalan Record</li>
