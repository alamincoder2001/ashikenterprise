...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="employee_id"> Select Employee </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="employee_id" id="employee_id" data-placeholder="Choose a Employee...">
                            ...
                            <?php
                            $query = $this->db->query("SELECT * FROM tbl_employee where status = 'a' order by Employee_Name asc");
                            $emp = $query->result();
                            foreach ($emp as $row) { ?>
                                <option value="<?php echo $row->Employee_SlNo; ?>" <?= ($selected->employee_id == $row->Employee_SlNo) ? 'selected' : ''; ?>><?php echo $row->Employee_Name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
...
<script type="text/javascript">
    function Updatesubmit() {
        ...
        var inputdata = 'id=' + id + '&username=' + username + '&user_email=' + user_email + '&rePassword=' + rePassword + '&txtFirstName=' + txtFirstName + '&Brunch=' + Brunch + '&type=' + type + '&oldpassword=' + oldpassword + '&employee_id=' + employee_id;
